...
public class Equipment{
   ...
   */
   public int put(){
      ...
      int result = -1;
      try{
         result = mySQL.setData("UPDATE Equipment SET EquipmentName = '" + equipmentName + "', EquipmentDescription = '" + equipmentDescription + "', EquipmentCapacity = " + equipmentCapacity + " WHERE EquipID = " + equipId + ";");
      }
      catch(DLException dle){
         System.out.println(dle.getMessage());
         return -1;
   ...
   */
   public int post(){
      ...
      int result = -1;
      try{
         result = mySQL.setData("INSERT INTO Equipment VALUES(" + equipId + ", '" + equipmentName + "', '" + equipmentDescription + "', " + equipmentCapacity + ");");
      }
      catch(DLException dle){
         System.out.println(dle.getMessage());
      }
   ...
   */
   public int delete(){
      ...
      int result = -1;
      try{
         result = mySQL.setData("DELETE FROM Equipment WHERE EquipID = " + equipId + ";");
      }
      catch(DLException dle){
         System.out.println(dle.getMessage());
      }
